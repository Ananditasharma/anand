...
public class ClosedContestAdapter extends RecyclerView.Adapter<ClosedContestAdapter.MyViewHolder> {

    private Context context;
    private ArrayList<String> list;

    public ClosedContestAdapter(Context context, ArrayList<String> list) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.contest_closed, parent, false);
