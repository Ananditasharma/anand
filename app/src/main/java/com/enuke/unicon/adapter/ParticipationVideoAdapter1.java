...
public class ParticipationVideoAdapter1 extends RecyclerView.Adapter<ParticipationVideoAdapter1.MyViewHolder> {

    private Context context;
    ArrayList<Boolean> list;
    private BookMarkListener bookMarkListener;

    public ParticipationVideoAdapter1(Context context, ArrayList<Boolean> list, BookMarkListener bookMarkListener) {
        this.context = context;
        this.list = list;
        this.bookMarkListener = bookMarkListener;
    }

    public ParticipationVideoAdapter1(Context context, ArrayList<Boolean> videoList, ParticipationVideoAdapter.BookMarkListener bookMarkListener) {
    }
