...
public class OngoingContestAdapter extends RecyclerView.Adapter<OngoingContestAdapter.MyViewHolder> {

    private Context context;
    private ArrayList<String> list;
boolean flag = true;

    public OngoingContestAdapter(Context context, ArrayList<String> list) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.ongoing_contest_item, parent, false);
