...
import com.enuke.unicon.adapter.MypageAdapter;
import com.enuke.unicon.utils.GridSpacingItemDecoration;

import java.util.ArrayList;

public class MyPageCreator1 extends Fragment implements View.OnClickListener {
    ...
    public static MyPageCreator1 newInstance() {
        MyPageCreator1 fragment = new MyPageCreator1();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.mypage_1, container, false);
    ...
    private void findViews(View view) {
        ...
        recyclermypage = view.findViewById(R.id.recyclermypage);
        ...
        recyclermypage.setLayoutManager(new GridLayoutManager(getContext(), 3));
        recyclermypage.addItemDecoration(new GridSpacingItemDecoration(3, 15, false));
        mypageAdapter = new MypageAdapter(getContext(), videoList, new MypageAdapter.BookMarkListener() {
            @Override
